...
{	
	static MFDBUTTONMENU personMenu[12] = {
		...
		{"Select base", "next to the button", '2'},
		{"Select base", "next to the button", '3'},
		{"Select base", "next to the button", '4'},
		{"Select base", "next to the button", '5'},
		{"Select base", "next to the button", '6'},
		{"Scan for bases", NULL, 'H'},
		{NULL, NULL, 0},
		{NULL, NULL, 0},
		{NULL, NULL, 0},
...
char *AscensionTowerData::GetSubtitle()
{
	...
	switch(state)
	{*/
	return scanList.size()>0?"Select base":"";
